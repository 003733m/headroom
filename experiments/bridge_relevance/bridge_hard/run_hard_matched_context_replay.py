...
MANIFEST = HERE / "hard_confirmatory_manifest.json"
PROTOCOL = HERE / "hard_matched_context_replay_protocol.json"
EXACT_PATH = HERE / "run_exact_wire_v3_replay.py"
OUT = ROOT / "hard_matched_context_replay_results.json"
...
def load_manifest() -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if set(tasks) != set(TASKS):
        die("Hard-six manifest task mismatch")
...
def main() -> None:
    ...
    payload = {
        "evaluation_type": "post_hoc_forensic_matched_replay",
