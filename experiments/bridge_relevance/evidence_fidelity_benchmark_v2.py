"""V2 controlled multi-position benchmark for trajectory-aware evidence fidelity.
...
RESULTS_DIR = Path("experiments/bridge_relevance/results/v2")
...
def main() -> None:
    ...
    summary = {
        "benchmark": "controlled_multi_position_evidence_fidelity_v2",
        "status": "v2_pre_freeze_controlled_mechanism_evaluation",
        "scoring_rule": "frozen_v1_score_x_normalized_target_specificity",
        "seed": SEED,
        "n_cases": N_CASES,
